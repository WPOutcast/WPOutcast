            ...
            <div class="col-lg-12">
              <div class="wpo-blog-post-box"> 
                ...
                <article class="small">
                  ...
                  <?php the_content(); ?>
                  <?php wp_link_pages( array( 'before' => '<div class="link single-post-link">' . __( 'Pages:', 'wpoutcast' ), 'after' => '</div>' ) ); ?>
                </article>
              </div>
            </div>
  		      <?php } ?>
            <div class="col-lg-12">
              <div class="media wpo-info-author-block"> <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>" class="wpo-author-pic"> <?php echo get_avatar( get_the_author_meta( 'ID') , 150); ?> </a>
